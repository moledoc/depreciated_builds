...
# $ "
setopt PROMPT_SUBST
PROMPT='%S%2d%K{yellow}$(parse_git_branch)%k%s '
...
alias moledoc="cd $HOME/Documents/moledoc"
...
alias nano="nano -T 4 -l -m -G -W -i -x -F" # -F
...
alias tg="ctags -R --exclude=.git --exclude=chromium -o tags go c"
